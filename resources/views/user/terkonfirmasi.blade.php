			...
			<ul class="nav nav-tabs c-font-uppercase c-font-bold c-margin-b-10 justify-content-center" role="tablist" style="border: none;">
              <li class="active">
				...
				<div class="sidenav bg-white">
				  ...
				  <a href="/dash/ordered"   class="c-font-16 c-font-uppercase mb-3 " ><i class="fal fa-shopping-cart"></i> Orders</a>
				</div>
			</li>
							...
							<nav class="navbar navbar-expand-lg navbar-light bg-light">
							  <div class=" text-center" id="navbarNav"  >
							    <ul class="navbar-nav">
							      ...
							      <li class="">
							        <a class="nav-link" href="#">Tunggu Konfirmasi</span></a>
							      </li>
							      <li class="active">
							        <a class="nav-link" href="#">Terkonfirmasi <span class="sr-only">(current)</a>
							      </li>
							      <li class="">
