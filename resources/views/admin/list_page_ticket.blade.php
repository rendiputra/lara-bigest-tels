...
@section('title', 'List Pemesan Ticket Yang Sudah Valid (Transfer)')
@section('content')
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col col-md-12 col-sm-12 col-12">
				...
				<div class="card" style="padding: 20px;">
					<h5>List Pemesan Ticket Yang Sudah Valid (Transfer)</h5><br>
    ...
    @endforeach
        				...
        				<span>Total Tiket Transfer : <b>{{ array_sum($total_jumlah2) }}</b></span>
				</div>
			</div>
		</div>
		<div class="spacer"></div>
